defmodule OhlcMovingWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(OhlcMovingWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(OhlcMovingWeb.Gettext, "errors", msg, opts)
    end
  end
